...
export default function PrivacyPolicy() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-16">
      <h1 className="text-4xl font-bold text-emerald-900 mb-2">Privacy Policy</h1>
      <p className="text-sm text-gray-500 mb-10">Last updated: February 2026</p>

      <div className="prose prose-gray max-w-none space-y-8 text-gray-700 leading-relaxed">

        <section>
          <h2 className="text-xl font-bold text-emerald-900 mb-3">What we collect</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold text-emerald-900 mb-3">How we use your data</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold text-emerald-900 mb-3">Emails</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold text-emerald-900 mb-3">Data storage</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold text-emerald-900 mb-3">Deleting your data</h2>
          <p>
