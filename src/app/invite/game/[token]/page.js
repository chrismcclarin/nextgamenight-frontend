    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center">
      <div className="bg-white rounded-xl shadow-lg p-8 max-w-md w-full mx-4">
        ...
        {status === 'joining' && (
          <div className="text-center">
            <div className="inline-block w-8 h-8 border-4 border-gray-200 border-t-emerald-600 rounded-full animate-spin mb-4" />
            <p className="text-gray-700 font-medium">Joining game night...</p>
          </div>
        )}
          ...
          <div className="text-center">
            ...
            {eventInfo && (
              <div className="mt-4 p-4 bg-gray-50 rounded-lg">
                <p className="font-semibold text-gray-900">{eventInfo.game_name || 'Game Night'}</p>
                <p className="text-sm text-gray-500">{formatEventDate(eventInfo.event_date)}</p>
              </div>
            )}
          </div>
        )}
