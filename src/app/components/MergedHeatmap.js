  ...
  return (
    <div>
      ...
      {membersWithoutData.length > 0 && !showSkeleton && (
        <div className="border border-line rounded-card p-3 text-sm text-content-secondary mb-4 flex items-start gap-2">
          <svg
      ...
      {/* Selected slot CTA */}
      {selectedSlot && (
        <div className="border border-line rounded-card p-3 text-content-primary font-medium mt-4 flex items-center justify-between">
