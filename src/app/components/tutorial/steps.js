...
const STEP_TEXTS = [
  ...
  },
  {
    ...
    text: 'Schedule a game night by creating an event. Pick a date, time, and game.',
    position: 'bottom',
    stepInteraction: false,
  },
  {
    selector: '[data-tutorial="game-voting"]',
    text: "Can't decide what to play? Start a vote and let the group choose.",
    position: 'top',
    stepInteraction: false,
  },
  {
    selector: '[data-tutorial="availability-heatmap"]',
    text: 'See when everyone is free. Brighter cells mean more people are available.',
    position: 'top',
    stepInteraction: false,
  },
  {
    selector: '[data-tutorial="availability-slots"]',
    text: "Tap a few time slots to share when you're free. Try it now!",
    position: 'top',
