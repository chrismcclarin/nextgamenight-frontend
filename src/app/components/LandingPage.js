...
export default function LandingPage() {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Hero */}
      <div className="bg-surface-nav text-content-inverse py-24 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <a
              ...
              className="bg-white/10 hover:bg-white/20 border border-white/30 text-content-inverse px-8 py-4 rounded-btn text-lg font-semibold transition-all w-full sm:w-auto text-center flex items-center justify-center gap-3"
            >
